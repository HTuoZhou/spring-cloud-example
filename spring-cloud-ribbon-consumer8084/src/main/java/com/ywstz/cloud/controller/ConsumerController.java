...
public class ConsumerController {
    ...
    @PostMapping("/add")
    public String add() {
        log.info("ribbon consumer count init 100");
        ...
        return "ribbon consumer count init 100" + "------>" + s;
    }

    @PostMapping("/reduce/{id}")
    public String reduce(@PathVariable Long id) {
        log.info("ribbon consumer count reduce ");
        ...
        return "ribbon consumer count reduce 1" + "------>" + s;
    }
